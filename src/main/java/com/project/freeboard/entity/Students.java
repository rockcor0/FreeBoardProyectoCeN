...
public class Students implements Serializable{
	...
	public String toString() {
		return "Students [cc=" + cc + ", name=" + name + ", email=" + email + ", phone="
				+ phone + ", bankWire=" + bankWire +", bank="+ bank+", accountType=" + accountType + ", university="+university+ 
				", career="+career+", titular="+titular+", experiencia="+experiencia+", skills="+skills+", password="+password+"]";
	}
